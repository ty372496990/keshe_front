<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline" ref="searchForm" :model="searchObj">
      ...
      <el-button type="default" @click="resetData('searchForm')">清空</el-button>
    </el-form>
    <el-table
  ...
  methods: {
    getListTeacher(page = 1) {
      ...
      teacher
        ...
        }) //如果请求成功返回20000，执行then
        .catch(response => {
          console.log(response);
        });
    },
    resetData(searchForm) {
      this.$nextTick(() => {
